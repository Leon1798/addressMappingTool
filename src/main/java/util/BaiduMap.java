 ...
 *         <String,String>> 密钥:C0a9eecc5b366bde41202sljdflsjfsldjf 需要自己去申请
...
public class BaiduMap {
	...
	public static Map<String, Double> getLngAndLat(String address) {
		...
		String url = "http://api.map.baidu.com/geocoder/v2/?address=" + address
				+ "&output=json&ak=knZ7b01292zrupudYR1hxa7yd2SIUsb6";
		try {
			...
			System.out.println("未找到相匹配的经纬度！" + e);
		}
		return map;
	}
	...
	public static Map<String, String> getProvinceAndCity(Double lng, Double lat) {
		...
		String url = "http://api.map.baidu.com/geocoder/v2/?ak=knZ7b01292zrupudYR1hxa7yd2SIUsb6&location=" + latAndLng
				+ "&output=json&pois=1";
		try {
			String json = loadJSON(url);
			JSONObject obj = JSONObject.fromObject(json);
